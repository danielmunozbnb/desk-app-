      ...
      "children": [
        {
          ...
          "columns": [
            ...
            },
            {
              ...
              "cellTemplate": {
                "type": "text",
                "enabled": "false",
                "value": "<% list:filter(pageVariables.getCatalog['Report_Entry'][0]['Skills_Survey_Catalog_group'], 'refId', apidata['referenceID'])[0]['category7'] %>"
              }
            },
            {
              "type": "column",
              ...
              "cellTemplate": {
                "type": "text",
                "enabled": "false",
                "value": "<% list:filter(pageVariables.getCatalog['Report_Entry'][0]['Skills_Survey_Catalog_group'], 'refId', apidata['referenceID'])[0]['category8'] %>"
              }
            },
            {
              "type": "column",
          ...
          "gridType": "LIST",
          "rows": "<% pageVariables.custOrgInfo.numberOfCategories == 8 ? flattenList(pageVariables.custOrgInfo.catalogCode) : null %>",
        ...
        },
        {
          ...
          "gridType": "LIST",
          "rows": "<% pageVariables.custOrgInfo.numberOfCategories == 7 ? flattenList(pageVariables.custOrgInfo.catalogCode) : null %>",
          "rowVariableName": "apidata",
          "indexVariableName": "index",
          "isArrayOutBinding": "false",
          "doNotPutInTab": true,
